...
$(function(){
	...
	var _broWidth = window.screen.width;
    if (_broWidth <= 980){
...
RollText.prototype = {
	initialize	:	function(cName,color1,color2){
		...
		for(var i=0;i<obj[0].getElementsByTagName("li").length;i++){
			var li = obj[0].getElementsByTagName("li")[i].getElementsByTagName("a")[0];
			li.style.position = "relative";
			li.style.overflow = "hidden";
			var text = li.getElementsByTagName("span")[0];
...
*/
	...
	var roll = new RollText("hbox","#666666","#ffffff");	
